...
export class Game{
  ...
  _makeLevels(n){
    const themes=[
      {top:'#102a5a', bottom:'#071024', hill:'#0b2250', glow:'#7dd3fc'},
      {top:'#2a1d5c', bottom:'#071024', hill:'#1b1242', glow:'#a78bfa'},
      {top:'#0b3a3a', bottom:'#06161a', hill:'#06303a', glow:'#5eead4'},
      {top:'#3a240b', bottom:'#120a04', hill:'#2b1406', glow:'#fbbf24'},
    ];
    const lvls=[];
    for(let i=0;i<n;i++){
